 ...
 */
function filterByTitle(aWindow, aTitle) {
 ...
 * @returns {Boolean} True if the condition is met.
 */
function filterByType(aWindow, aType) {
...
// Export of methods
windows.filterByTitle = filterByTitle;
windows.filterByType = filterByType;

windows.getLastOpenedWindow = getLastOpenedWindow;
windows.getLastOpenedWindows = getLastOpenedWindows;
windows.getMostRecentWindow = getMostRecentWindow;
windows.getMostRecentWindows = getMostRecentWindows;
