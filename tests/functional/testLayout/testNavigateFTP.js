...
// Links to navigate through on the FTP server
const LINK_NAMES = ['firefox', 'nightly', 'latest-trunk'];
...
function testNavigateFTP() {
  ...
  LINK_NAMES.forEach(function (aName) {
    var link = tab.findElement("link", aName);
    link.click();
