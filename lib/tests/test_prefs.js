...
function testPreferences() {
  ...
  // Test a preference wrapper
  let test = TEST_DATA[2];

  prefs.setPref(test.type, test.pref, test.value);
  let userValue = prefs.getHomepage();
  let defaultValue = prefs.getHomepage(prefs.defaultBranch);
  expect.notEqual(userValue, defaultValue, "The default value is different from the user value");
