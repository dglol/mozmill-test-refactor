...
var Browser = {
  get navBar() {
    ...
    return new navBar.NavBar("tag", "#nav-bar", this._window.document);
  },

  get tabBar() {
    // TODO: Cache the instance
    return new tabBar.TabBar("tag", "#TabsToolbar", this._window.document);
  },
  ...
  openURL: function Browser_openURL(aURL, aTimeout) {
    this.navBar.urlBarText.type(aURL);
