 ...
 *
 */
Window.prototype.__defineGetter__("closed", function Window_getClosed() {
 ...
 *
 */
Window.prototype.__defineGetter__("innerWindow", function Window_getInnerWindow() {
  return this._window;
});
 ...
 *
 */
Window.prototype.__defineGetter__("title", function Window_getTitle() {
 ...
 *
 */
Window.prototype.__defineGetter__("type", function Window_getType() {
 ...
 *
 */
Window.prototype.handleWindow = function Window_handleWindow(aFilterCallback,
                                                             aValue, aCallback,
                                                             aClose) {
  let win = null;
 ...
 *
 */
Window.prototype.addMap = function Window_addMap(aMixinClass) {
