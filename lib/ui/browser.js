...
function getBrowserWindow(aOpenIfNone) {
  let { BrowserWindow } = require('../ui/browser');

  return browser = new BrowserWindow(driver.getBrowserWindow(aOpenIfNone));
}
...
function openBrowserWindow() {
  ...
  return browser = new BrowserWindow(driver.openBrowserWindow());
}
