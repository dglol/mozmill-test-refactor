...
/**
 * Returns the reference to the main menu of the current browser window
 */
BrowserUI.prototype.__defineGetter__("mainMenu",
                                     function BrowserUI_getMainMenu() {
  return this._controller.mainMenu;
});
