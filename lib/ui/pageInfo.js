...
function PageInfoUI(aDocument) {
  ...
  this.topBar = new TopBar("tag", "#topBar", this);
 ...
 *
 */
function TopBar(aLocatorType, aLocator, aOwner) {
  widgets.Region.apply(this, arguments);

  this.categories = new widgets.RadioGroup("tag", "#viewGroup", this);
}
inheritance.extend(TopBar, widgets.Region);
