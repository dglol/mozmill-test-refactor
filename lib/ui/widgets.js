...
Element.prototype._getCollector = function Element_getCollector() {
...
Element.prototype._validateLocatorType = function element_validateLocatorType(aLocatorType) {
  switch (aLocatorType) {
    case "node":
    case "id":
    case "xpath":
...
Element.prototype._locateElem = function Element_locateElem() {
