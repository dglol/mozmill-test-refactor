...
function ModalDialogObserver_findWindow() {
  ...
  let win = mozmill.utils.unwrapNode(driver.getNewestWindow());
 ...
 */
ChromeWindowWrapper.prototype.__defineGetter__("innerWindow", function ChromeWindowWrapper_getInnerWindow() {
  return this._window;
});
 ...
 * @returns {DOMWindow} The DOM window.
 */
ChromeWindowWrapper.prototype.__defineGetter__("isLoaded", function ChromeWindowWrapper_isLoaded() {
 ...
 */
ChromeWindowWrapper.prototype.keypress =
function ChromeWindowWrapper_keypress(aKeyCode, aModifiers) {
 ...
 */
ChromeWindowWrapper.prototype.addEventListener =
function ChromeWindowWrapper_addEventListener(aType, aListener, aUseCapture,
                                              aWantsUntrusted) {
 ...
 */
ChromeWindowWrapper.prototype.removeEventListener =
function ChromeWindowWrapper_removeEventListener(aType, aListener, aUseCapture) {
 ...
 *
 * @memberOf windows
 * @param {DOMWindow} aDOMWindow Window instance to check
 * @returns {Boolean} True, if the window content has been loaded
 */
function isWindowLoaded(aDOMWindow) {
  return ("mozmillDocumentLoaded" in aDOMWindow) &&
         aDOMWindow.mozmillDocumentLoaded;
}
