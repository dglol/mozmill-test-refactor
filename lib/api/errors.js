...
function constructError(aClassName) {
  var constructor = function(aMessage, aFileName, aLineNumber) {
    let error = new Error();
 ...
 * @param {String} aFunction Function in which the the error occured.
 */
errors.InvalidParameterError = constructError("InvalidParameterError");
...
/**
 * Custom error for unknown entities
 *
