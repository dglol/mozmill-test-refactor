...
/**
 * Service for the crash reporter (Breakpad)
 *
 * @see <a href="http://mxr.mozilla.org/mozilla-central/source/xpcom/system/nsICrashReporter.idl">nsICrashReporter</a>
 */
XPCOMUtils.defineLazyGetter(services, "crashReporter", function () {
  return Cc["@mozilla.org/toolkit/crash-reporter;1"].
 ...
 */
XPCOMUtils.defineLazyGetter(services, "placesImportExport", function () {
